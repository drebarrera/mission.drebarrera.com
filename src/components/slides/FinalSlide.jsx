    ...
    <section className="fixed w-full min-h-screen p-4 sm:p-6 md:p-[7%]">
      ...
      >
        <motion.div className="w-full h-full p-2 sm:p-4 md:p-[15px] rounded-lg flex flex-col lg:flex-row gap-0 sm:gap-6 md:gap-[35px] items-stretch lg:items-start">
          <SlideItem show={[0.9, 1.5]} duration={[0.02, 0.02]}>
              {/* CDMX */}
              <motion.div 
          ...
          <motion.div className="flex flex-col items-start grow-0 gap-3 sm:gap-5 md:gap-[20px] mt-4 lg:mt-0">
            ...
            <SlideItem show={[0.9, 1.5]} duration={[0.02, 0.02]}>
              <p className="text-white text-sm sm:text-base md:text-lg text-left whitespace-pre-line">
                I'm continuously building toward what's next. I value opportunities to work with organizations that share my passion for impact-driven technology.<br/><br/>
            ...
            <div className="w-full flex flex-row gap-x-2 gap-y-3 mt-[10px] items-center flex-wrap">
              <SlideItem show={[0.9, 1.5]} duration={[0.02, 0.02]}>
                <a href="https://www.drebarrera.com" target="_blank" rel="noopener noreferrer" className="w-fit h-fit px-[10px] py-[4px] border-1 border-white bg-white text-black text-base md:text-lg text-left font-medium" style={{borderRadius: "15px"}}>
              ...
              <SlideItem show={[0.9, 1.5]} duration={[0.02, 0.02]}>
                <a href="https://pixelvisa.drebarrera.com" target="_blank" rel="noopener noreferrer" >
